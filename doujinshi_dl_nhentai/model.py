...
from doujinshi_dl_nhentai.constant import DETAIL_URL, IMAGE_URL
from doujinshi_dl.core.logger import logger
from doujinshi_dl.core.utils.fs import format_filename
...
if __name__ == '__main__':
    test = Doujinshi(name='test doujinshi', id=1)
    print(test)
    test.show()
    try:
        test.download()
